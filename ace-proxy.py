...
def get_upstream_url(req):
    upstream_url = req.headers.get("ACETV_URL")
    if upstream_url is None:
        upstream_url = os.path.dirname(req.base_url)
    return upstream_url
...
def get_style():
    return send_from_directory("./src/css/", "style.css")


@app.route("/src/js/script.js")
def get_js():
    return send_from_directory("./src/js/", "script.js")
